...
public class PdfGeneratorManager {
    ...
    public static void createPdf(Date start, Date end) throws IOException, DocumentException {
        ...
        new PdfGeneratorManager().fillPdf(FILE, start, end);
    }
    ...
    public void fillPdf(String dest, Date start, Date end) throws IOException, DocumentException {
        ...
        if(start.toString().equals(end.toString())){
            paragraph = new Paragraph(
                    "Report generated by: " + ui.getName() + " " + ui.getSurname() + "\n\nData generated: " + simpleDateFormat.format(now)
                            + "\n\nOf : " + start,tableFont);
        }
        else{
            paragraph = new Paragraph(
                    "Report generated by: " + ui.getName() + " " + ui.getSurname() + "\n\nData generated: " + simpleDateFormat.format(now)
                            + "\n\nFrom the period: " + start + " " + localEnd,tableFont);
        }
