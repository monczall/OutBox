...
public enum PackageStatus {
    ...
    IN_MAIN_SORTING_DEPARTMENT("W Głównej Sortowni", "In Main Hub"),
    TO_DELIVERY("Przekazana Do Doręczenia", "Handed Over For Delivery"),
    DELIVERED("Dostarczona", "Delivered"),
    ABSENCE_OF_THE_RECIPENT("Nieobecność Odbiorcy", "Recipient's Absence"),
    SECOND_TRY_TO_DELIVERY("Ponowna Próba Doręczenia", "Retry Delivery"),
    ...
    RETURNED_TO_THE_SENDER("Zwrócona Do Nadawcy", "Returned To The Sender");
